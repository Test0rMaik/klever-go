...
func CreateGasConfig(gasMap GasScheduleMap) (*GasCost, error) {
	builtIn := &BuiltInCost{}
	err := mapstructure.Decode(gasMap["BuiltInCost"], builtIn)
	if err != nil {
		return nil, err
	}
...
func FillGasMap(gasMap GasScheduleMap, value uint64) GasScheduleMap {
	...
	gasMap["BaseOpsAPICost"] = FillGasMapBaseOpsAPICosts(value)
...
func FillGasMapBuiltInCosts(value uint64) map[string]uint64 {
	...
	gasMap["Transfer"] = value
	gasMap["CreateAsset"] = value
	gasMap["CreateValidator"] = value
	gasMap["ValidatorConfig"] = value
	gasMap["Freeze"] = value
	gasMap["Unfreeze"] = value
	gasMap["Delegate"] = value
	gasMap["Undelegate"] = value
	gasMap["Withdraw"] = value
	gasMap["Claim"] = value
	gasMap["Unjail"] = value
	gasMap["AssetTrigger"] = value
	gasMap["SetAccountName"] = value
	gasMap["Proposal"] = value
	gasMap["Vote"] = value
	gasMap["ConfigITO"] = value
	gasMap["Buy"] = value
	gasMap["Sell"] = value
	gasMap["CancelMarketOrder"] = value
	gasMap["CreateMarketplace"] = value
	gasMap["ConfigMarketplace"] = value
	gasMap["UpdateAccountPermission"] = value
...
func FillGasMapBaseOpsAPICosts(value uint64) map[string]uint64 {
	gasMap := make(map[string]uint64)
...
func MakeGasMapForTests() GasScheduleMap {
	return MakeGasMap(GasValueForTests)
}
