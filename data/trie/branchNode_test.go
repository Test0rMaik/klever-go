...
func getTestMarshalizerAndHasher() (marshal.Marshalizer, hashing.Hasher) {
	marsh := &marshal.ProtoMarshalizer{}
...
func TestBranchNode_getHash(t *testing.T) {
	...
	bn := &branchNode{CollapsedBn: &CollapsedBn{}, baseNode: &baseNode{hash: []byte("test hash")}}
...
func TestBranchNode_isDirty(t *testing.T) {
	...
	bn := &branchNode{CollapsedBn: &CollapsedBn{}, baseNode: &baseNode{dirty: true}}
	assert.Equal(t, true, bn.isDirty())

	bn = &branchNode{CollapsedBn: &CollapsedBn{}, baseNode: &baseNode{dirty: false}}
...
func TestBranchNode_getCollapsed(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.True(t, proto.Equal(collapsedBn, collapsed.(*branchNode)))
}
...
func TestBranchNode_setGivenHash(t *testing.T) {
	...
	bn := &branchNode{CollapsedBn: &CollapsedBn{}, baseNode: &baseNode{}}
...
func TestBranchNode_resolveCollapsed(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, resolved.getHash(), collapsedBn.children[childPos].getHash())
}
...
func TestBranchNode_clone(t *testing.T) {
	...
	assert.True(t, proto.Equal(bn, clone))
}
...
func TestBranchNode_commitCollapsesTrieIfMaxTrieLevelInMemoryIsReached(t *testing.T) {
	...
	assert.True(t, proto.Equal(collapsedBn, bn))
}
