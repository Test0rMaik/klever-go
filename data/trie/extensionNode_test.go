...
func TestExtensionNode_getHash(t *testing.T) {
	...
	en := &extensionNode{CollapsedEn: &CollapsedEn{}, baseNode: &baseNode{hash: []byte("test hash")}}
...
func TestExtensionNode_isDirty(t *testing.T) {
	...
	en := &extensionNode{CollapsedEn: &CollapsedEn{}, baseNode: &baseNode{dirty: true}}
	assert.Equal(t, true, en.isDirty())

	en = &extensionNode{CollapsedEn: &CollapsedEn{}, baseNode: &baseNode{dirty: false}}
...
func TestExtensionNode_getCollapsed(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, collapsedEn.clone(), collapsed)
}

func TestExtensionNode_getCollapsedEmptyNode(t *testing.T) {
	t.Parallel()

	en := &extensionNode{CollapsedEn: &CollapsedEn{}}
...
func TestExtensionNode_setHashEmptyNode(t *testing.T) {
	...
	en := &extensionNode{CollapsedEn: &CollapsedEn{}, baseNode: &baseNode{}}
...
func TestExtensionNode_clone(t *testing.T) {
	...
	assert.True(t, proto.Equal(en, clone))
}
...
func TestExtensionNode_deepCloneShouldWork(t *testing.T) {
	...
	en := &extensionNode{baseNode: &baseNode{}, CollapsedEn: &CollapsedEn{}}
	en.dirty = true
	en.hash = getRandomByteSlice()
	en.EncodedChild = getRandomByteSlice()
	en.Key = getRandomByteSlice()
...
func TestExtensionNode_newExtensionNodeNilMarshalizerShouldErr(t *testing.T) {
	...
	en, err := newExtensionNode([]byte("key"), &branchNode{CollapsedBn: &CollapsedBn{}}, nil, mock.HasherMock{})
	assert.Nil(t, en)
...
func TestExtensionNode_newExtensionNodeNilHasherShouldErr(t *testing.T) {
	...
	en, err := newExtensionNode([]byte("key"), &branchNode{CollapsedBn: &CollapsedBn{}}, &mock.MarshalizerMock{}, nil)
	assert.Nil(t, en)
...
func TestExtensionNode_newExtensionNodeOkVals(t *testing.T) {
	...
	marsh, hasher := getTestMarshalizerAndHasher()
	key := []byte("key")
	child := &branchNode{CollapsedBn: &CollapsedBn{}}
